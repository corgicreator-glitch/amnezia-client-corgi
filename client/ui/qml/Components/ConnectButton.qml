    ...
    background: Item {
        ...
        Shape {
            ...
            ShapePath {
                ...
                PathAngleArc { centerX: backgroundCircle.width/2; centerY: backgroundCircle.height/2; radiusX: 94; radiusY: 94; startAngle: 0; sweepAngle: 360 }
            }
            ShapePath {
                fillColor: AmneziaStyle.color.transparent
                strokeColor: {
                    if (ConnectionController.isConnectionInProgress) return AmneziaStyle.color.mutedGray
                    if (ConnectionController.isConnected)            return connectedButtonColor
                    return defaultButtonColor
                }
                strokeWidth: root.buttonActiveFocus ? 2 : 3
                capStyle: ShapePath.RoundCap
                PathAngleArc { centerX: backgroundCircle.width/2; centerY: backgroundCircle.height/2; radiusX: 93-(root.buttonActiveFocus?2:0); radiusY: 93-(root.buttonActiveFocus?2:0); startAngle: 0; sweepAngle: 360 }
            }
        ...
        Shape {
            ...
            ShapePath {
                ...
                PathAngleArc { centerX: shape.width/2; centerY: shape.height/2; radiusX: 93; radiusY: 93; startAngle: 245; sweepAngle: -180 }
            }
            RotationAnimator { target: shape; running: ConnectionController.isConnectionInProgress; from: 0; to: 360; loops: Animation.Infinite; duration: 900 }
        }
    }
